package com.lucasbandeira.icompras.pedidos.subscriber;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.lucasbandeira.icompras.pedidos.service.AtualizacaoStatusPedidoService;
import com.lucasbandeira.icompras.pedidos.subscriber.representation.AtualizacaoStatusPedidoRepresentation;
...
public class AtualizacaoStatusPedidoSubscriber {
    ...
    public void receberAtualizacao(String json){
        ...
        try {
            ...
            service.atualizarStatus(atualizacaoStatus.codigo(), atualizacaoStatus.statusPedido(), atualizacaoStatus.urlNotaFiscal(), atualizacaoStatus.codigoRastreio());
